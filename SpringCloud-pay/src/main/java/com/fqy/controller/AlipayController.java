...
public class AlipayController {
    @RequestMapping("/pay")
    @ResponseBody
    public String pay(@RequestBody Map map , HttpServletRequest request , HttpServletResponse response){

        Integer json = (Integer) map.get("json");
        ...
        //支付宝的回调地址,支付结果异步通知
        aplirequest.setNotifyUrl( "http://1bbd091e.nat.nsloop.com/springcloud-pay/returlCallBack" ); //在公共参数中设置回跳和通知地址
